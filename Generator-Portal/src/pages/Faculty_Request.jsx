      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div className="p-3 sm:p-6 flex flex-row justify-between items-center">
              <div className="flex items-center space-x-2 sm:space-x-4">
                ...
                <div className="pl-1 sm:pl-2 min-w-0">
                  <h2 className="text-[11px] sm:text-2xl font-bold text-blue-900 tracking-tight">Faculty Request Letter Generator</h2>
        ...
        <div className="shadow-xl rounded-2xl overflow-hidden">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="px-8 py-8 space-y-6 bg-gradient-to-br from-blue-50 to-sky-50">
            ...
            {/* Form Actions */}
            <div className="flex flex-row items-center justify-between gap-3 sm:gap-6 pt-6 border-t border-gray-200">
              <button
                type="button"
                onClick={resetForm}
              ...
              <button
                type="submit"
                disabled={isGeneratingPdf}
                className="px-3 sm:px-5 py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 to-sky-600 hover:from-blue-600 hover:to-sky-700 border border-transparent rounded-lg shadow-md text-xs sm:text-sm font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-70 flex items-center gap-1 sm:gap-2 whitespace-nowrap"
              >
                {isGeneratingPdf ? (
                  <>
                  ...
                  <>
                    ...
                    <span className="hidden sm:inline">Generate Letter PDF</span>
